            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?=$pageName=='login' ? 'active' : ''?> " href="login-admin-form.php">登入</a>
                  </li>

                  <?php else:?>
                  <li class="nav-item">
                    <a class="nav-link">您好，<?= $_SESSION['admin']['account'] ?></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="logout-admin-api.php">登出</a>
                  </li>
                  <?php endif; ?>
                </ul>
              </div>
